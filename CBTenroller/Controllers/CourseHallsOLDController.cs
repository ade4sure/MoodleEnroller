...
{
    [Authorize]
    public class CourseHallsOLDController : Controller
    {
        private readonly ApplicationDbContext _context;

        public CourseHallsOLDController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var applicationDbContext = _context.CourseHalls.Include(c => c.Course).Include(c => c.Hall);
        ...
        public async Task<IActionResult> Create([Bind("Id,CourseId,HallId,StartTime,StopTime")] CourseHall courseHall)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CourseId,HallId,StartTime,StopTime")] CourseHall courseHall)
        {
            if (id != courseHall.Id)
            {
                return NotFound();
